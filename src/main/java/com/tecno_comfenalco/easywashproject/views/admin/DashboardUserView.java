...
public class DashboardUserView extends javax.swing.JFrame {
    ...
    public DashboardUserView(String session) {
        this.session = session;

        UserRepositoryImpl userRepository = new UserRepositoryImpl();
        this.user = userRepository.findByDocumentNumber(session);
    ...
    private void initComponents() {
        ...
        if (session != null) {
            TextTitulo.setText("¡Bienvenido al Sistema, " + user.getFullname() + "!");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardUserView.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
