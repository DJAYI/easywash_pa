...
public class LoginUserView extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(ActionEvent ev) {
        ...
        boolean authentication = authController.authenticateUser(IngresarUsuario.getText(),
                String.copyValueOf(IngresarContraseña.getPassword()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginUserView.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
